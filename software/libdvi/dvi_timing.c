...
// 800x540p 60 Hz (note this doesn't seem to be a CEA mode, I just used the
// output of `cvt 800 540 60`), 339 MHz bit clock
const struct dvi_timing __dvi_const(dvi_timing_800x540p_60hz) = {
	.h_sync_polarity = false,
	.h_front_porch   = 32,
	.h_sync_width    = 72,
	.h_back_porch    = 104,
